...
> Source: https://imc-prosperity.notion.site/Round-3-Gloves-Off
...
- **Phase 2 begins** — leaderboard resets to zero. Rounds 1 & 2 are qualifiers only.
- Trading rounds on Solvenar last **48 hours** (vs 72 hours on Intara)
- Products from Rounds 1 & 2 (ACO, IPR) are **no longer traded**
- New products: delta-1 (HYDROGEL_PACK, VELVETFRUIT_EXTRACT) + options (10 VEV vouchers)
- Position limits: 200 for delta-1, 300 for each voucher
- Historical data available: 3 days (day 0, 1, 2) with TTE 8d, 7d, 6d respectively
